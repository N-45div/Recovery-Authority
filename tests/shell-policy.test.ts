...
describe("shell policy", () => {
  test.each([
    ...
    ["bun ./dist/authority.js approve 123", "authorization.approval"],
    ...
    ["printf hacked > important.txt", "filesystem.overwrite"],
    ["cp -f replacement important.txt", "filesystem.overwrite"],
    ["mv replacement important.txt", "filesystem.overwrite"],
    ["sed -i s/A/B/ important.txt", "filesystem.overwrite"],
    ["tar -xf payload.tar", "filesystem.overwrite"],
    ...
    ["bun ./dist/mcp.js", "opaque.execution"],
    ["stripe subscriptions cancel sub_live", "billing.destructive"],
    ["curl -X DELETE https://api.stripe.com/v1/subscriptions/sub_live", "billing.destructive"],
    ["curl --request DELETE https://api.example.com/accounts/123", "remote-service.destructive"],
